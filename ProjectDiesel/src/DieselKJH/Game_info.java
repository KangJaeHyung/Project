...
public class Game_info {
	...
	private ImageIcon game_bigimage;
	public Game_info(String game_code, String game_name, int game_price, String game_launch_date, String game_grade,
			String game_main_genre, String game_sub_genre, String game_image_dir, String game_bigimage_dir) {
		super();
		...
		game_image=new ImageIcon(Main.class.getResource("../DieselImage/"+this.game_image_dir));
		game_bigimage=new ImageIcon(Main.class.getResource("../DieselImage/"+this.game_bigimage_dir));
	}
	
	
	public ImageIcon getGame_image() {
		return game_image;
	}


	public ImageIcon getGame_bigimage() {
		return game_bigimage;
	}
